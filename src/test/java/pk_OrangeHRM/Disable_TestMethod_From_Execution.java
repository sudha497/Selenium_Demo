...
public class Disable_TestMethod_From_Execution {
    ...
    @Test(priority=2, description = "Adding Users Functionality", expectedExceptions={NoSuchElementException.class})
    //@Test(priority=2)
    ...
    @Test(priority=3, description = "Checking Added User", enabled=false)
